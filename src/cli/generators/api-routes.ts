...
const publicationId = beehiivConfig.publicationId;
...
export async function GET(
  ...
  try {
    ...
    const subscription = await client.subscriptions.getById(publicationId, id);
